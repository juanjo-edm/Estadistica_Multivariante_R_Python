...
```{r include=FALSE}
bfi_items_py <- psych::bfi[, 1:25]
bfi_items_py <- stats::na.omit(bfi_items_py)
```
...
# ---------- 1) Datos ----------
# Usamos el dataset "bfi" de personalidad desde R psych::bfi.
# Así evitamos depender de OpenML durante el render.
df = r.bfi_items_py.copy()  # ítems A1:A5, C1:C5, E1:E5, N1:N5, O1:O5
