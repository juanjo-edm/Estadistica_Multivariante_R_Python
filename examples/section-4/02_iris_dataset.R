...
##################################################################################################################
# Obtener los boxplots (solo para las variables num�ricas)
##################################################################################################################
...
##################################################################################################################
# Obtener los boxplots (solo para las variables num�ricas) separados por especie para cada variable
##################################################################################################################
...
##################################################################################################################
# Histogramas para las variables cuantitativas con m�todo �ptimo para determinar el ancho de las barras (binwidth)
##################################################################################################################
...
##################################################################################################################
# Densidad Kernel para las variables con el ancho de banda (bandwidth) �ptimo y el Kernel Gaussiano 
##################################################################################################################
...
##################################################################################################################
# Scatterplot m�ltiple, dividido por subgrupos en cada gr�fico
##################################################################################################################
...
depth.Y <- depth.halfspace(Y[,1:4],Y[,1:4],num.directions=100000,seed=1) # Obtener la soluci�n aproximada basada en 100000 proyecciones
sort.depth.Y <- sort(depth.Y,decreasing=TRUE,index.return=TRUE) # Ordenar las profundidades

depth.Y.sort <- sort.depth.Y$x # Las profundidades ordenadas, desde la m�s profunda hasta la menos profunda, con respecto al centro
depth.Y.sort
