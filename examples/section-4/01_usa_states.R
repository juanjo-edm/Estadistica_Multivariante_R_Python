...
?state.x77 #informaci�n sobre el dataset
#Cargar los datos
...
##################################################################################################################
# Histogramas para todas las variables con ancho de barra "�ptimo" - - opcion breaks=Sturges
##################################################################################################################
...
##################################################################################################################
# Scatterplot m�ltiple de todas los pares de varaibles.
##################################################################################################################
...
depth.X <- depth.halfspace(X,X,num.directions=100000,seed=1) # Obtener la soluci�n aproximada basada en 100000 proyecciones
sort.depth.X <- sort(depth.X,decreasing=TRUE,index.return=TRUE) # Ordenar las profundidades

depth.X.sort <- sort.depth.X$x # Las profundidades ordenadas, desde la m�s profunda hasta la menos profunda, con respecto al centro
depth.X.sort
